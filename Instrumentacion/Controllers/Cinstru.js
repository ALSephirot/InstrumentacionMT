  ...
  exports.addUser = function(req, res) {
    ...
    try
    {
      var user = new Instru({
        Informacion:
        {
          evento: req.body.BasicInfo.evento,
          modulo: req.body.BasicInfo.modulo,
          detalle_evento: req.body.BasicInfo.detalle_evento,
          plataforma: req.body.BasicInfo.plataforma,
          idCelular: req.body.BasicInfo.idCelular,
          Datetime: req.body.BasicInfo.Datetime
        }
      });
